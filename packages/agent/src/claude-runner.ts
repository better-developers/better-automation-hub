...
import type { FetchedItem, McpServerConfig } from './integrations'

// ---------------------------------------------------------------------------
// Re-export canonical types so integration files can import from '../claude-runner'
// ---------------------------------------------------------------------------

export type { FetchedItem, McpServerConfig, Integration } from './integrations'
